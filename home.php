...
<br><div class="container" >
  ...
  <div class="row" align="center">
    ...
    <body>
        ...
        <!--Method One-->
        <div class="form-group">
			<label class="col-md-4 control-label" for="Course">Matéria</label> 
			<div class="col-md-5">
...
<body>
    ...
    <body>
		...
		<!-- Method Two -->
        <div class="form-group">
			<label class="col-md-4 control-label" for="subject">Módulo</label> 
			<div class="col-md-5">
...
<meta charset="UTF-8">
    ...
    <body>
		...
		<!-- Method Two -->
        <div class="form-group">
			<label class="col-md-4 control-label" for="room">Dia</label> 
			<div class="col-md-5">
