...
<body>
            ...
            <td>";
               ...
               mysqli_select_db($mysqli,$database) or die(mysqli_error($mysqli)); 
                    ...
                    echo "<div class='container'><table width='' class='table table-bordered' border='1' >
                        ...
                        {
                        echo "<tr>";
                        echo "<td>" . $row['start_timeEAD'] . "</td>";
						            echo "<td>" . $row['end_timeEAD'] . "</td>";
                        echo "<td><form class='form-horizontal' method='post' action='timelistEAD.php'>
    ...
    $sql = mysqli_query($mysqli,"DELETE FROM timerEAD WHERE id='$id'");
    if(!$sql)
    {
